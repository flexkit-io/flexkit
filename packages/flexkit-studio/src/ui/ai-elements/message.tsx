...
export const MessageBranch = ({
  ...
  return (
    <MessageBranchContext.Provider value={contextValue}>
      <div
        className={cn("fk:grid fk:w-full fk:gap-2 fk:[&>div]:pb-0", className)}
        {...props}
      />
...
export const MessageBranchSelector = ({
  ...
  return (
    <ButtonGroup
      className={cn(
        "fk:[&>*:not(:first-child)]:rounded-l-md fk:[&>*:not(:last-child)]:rounded-r-md",
        className
      )}
...
export const MessageBranchPage = ({
  ...
  return (
    <ButtonGroupText
      className={cn(
        "fk:border-none fk:bg-transparent fk:text-muted-foreground fk:shadow-none",
        className
      )}
      {...props}
    >
...
export const MessageResponse = memo(
  ({ className, ...props }: MessageResponseProps) => (
    <Streamdown
      className={cn(
        "fk:size-full fk:[&>*:first-child]:mt-0 fk:[&>*:last-child]:mb-0",
        className
      )}
...
export const MessageToolbar = ({
  ...
  <div
    className={cn(
      "fk:mt-4 fk:flex fk:w-full fk:items-center fk:justify-between fk:gap-4",
      className
    )}
    {...props}
  >
