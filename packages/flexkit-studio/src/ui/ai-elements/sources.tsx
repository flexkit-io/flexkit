...
export const Sources = ({ className, ...props }: SourcesProps) => (
  <Collapsible className={cn('fk:not-prose fk:mb-4 fk:text-primary fk:text-xs', className)} {...props} />
);
...
export const SourcesTrigger = ({ className, count, children, ...props }: SourcesTriggerProps) => (
  <CollapsibleTrigger className={cn('fk:flex fk:items-center fk:gap-2', className)} {...props}>
    {children ?? (
      <>
...
export const Source = ({ href, title, children, ...props }: SourceProps) => (
  <a className="fk:flex fk:items-center fk:gap-2" href={href} rel="noreferrer" target="_blank" {...props}>
    {children ?? (
      <>
