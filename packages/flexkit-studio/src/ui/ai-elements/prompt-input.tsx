...
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupTextarea } from '../primitives/input-group';
...
export const PromptInputActionAddAttachments = ({
  ...
  return (
    <DropdownMenuItem {...props} onSelect={handleSelect}>
      <ImageIcon className="fk:mr-2 fk:size-4" /> {label}
    </DropdownMenuItem>
  );
};
...
export const PromptInputActionAddScreenshot = ({
  ...
  return (
    <DropdownMenuItem {...props} onSelect={handleSelect}>
      <Monitor className="fk:mr-2 fk:size-4" />
      {label}
    </DropdownMenuItem>
  );
};
  ...
  const inner = (
    <>
      <input
        ...
        type="file"
      />
      <form className={cn('fk:w-full', className)} onSubmit={handleSubmit} ref={formRef} {...props}>
        <InputGroup className="fk:overflow-hidden">{children}</InputGroup>
      </form>
    </>
  );
...
export const PromptInputBody = ({ className, ...props }: PromptInputBodyProps) => (
  <div className={cn('fk:contents', className)} {...props} />
);
...
export const PromptInputTextarea = ({
  ...
  return (
    <InputGroupTextarea
      className={cn('fk:field-sizing-content fk:max-h-48 fk:min-h-16', className)}
      name="message"
...
export const PromptInputHeader = ({ className, ...props }: PromptInputHeaderProps) => (
  <InputGroupAddon align="block-end" className={cn('fk:order-first fk:flex-wrap fk:gap-1', className)} {...props} />
);

export type PromptInputFooterProps = Omit<ComponentProps<typeof InputGroupAddon>, 'align'>;

export const PromptInputFooter = ({ className, ...props }: PromptInputFooterProps) => (
  <InputGroupAddon align="block-end" className={cn('fk:justify-between fk:gap-1', className)} {...props} />
);

export type PromptInputToolsProps = HTMLAttributes<HTMLDivElement>;

export const PromptInputTools = ({ className, ...props }: PromptInputToolsProps) => (
  <div className={cn('fk:flex fk:min-w-0 fk:items-center fk:gap-1', className)} {...props} />
);
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side={side}>
        {tooltipContent}
        {shortcut && <span className="fk:ml-2 fk:text-muted-foreground">{shortcut}</span>}
      </TooltipContent>
    </Tooltip>
  );
};
...
export const PromptInputActionMenuTrigger = ({ className, children, ...props }: PromptInputActionMenuTriggerProps) => (
  <DropdownMenuTrigger asChild>
    <PromptInputButton className={className} {...props}>
      {children ?? <PlusIcon className="fk:size-4" />}
    </PromptInputButton>
  </DropdownMenuTrigger>
);
...
export const PromptInputSubmit = ({
  ...
  let Icon = <CornerDownLeftIcon className="fk:size-4" />;

  if (status === 'submitted') {
    Icon = <Spinner />;
  } else if (status === 'streaming') {
    Icon = <SquareIcon className="fk:size-4" />;
  } else if (status === 'error') {
    Icon = <XIcon className="fk:size-4" />;
  }
...
export const PromptInputSelectTrigger = ({ className, ...props }: PromptInputSelectTriggerProps) => (
  <SelectTrigger
    className={cn(
      'fk:border-none fk:bg-transparent fk:font-medium fk:text-muted-foreground fk:shadow-none fk:transition-colors',
      'fk:hover:bg-accent fk:hover:text-foreground fk:aria-expanded:bg-accent fk:aria-expanded:text-foreground',
      className
    )}
    {...props}
  />
...
export const PromptInputTabLabel = ({ className, ...props }: PromptInputTabLabelProps) => (
  ...
  <h3 className={cn('fk:mb-2 fk:px-3 fk:font-medium fk:text-muted-foreground fk:text-xs', className)} {...props} />
);

export type PromptInputTabBodyProps = HTMLAttributes<HTMLDivElement>;

export const PromptInputTabBody = ({ className, ...props }: PromptInputTabBodyProps) => (
  <div className={cn('fk:space-y-1', className)} {...props} />
);
...
export const PromptInputTabItem = ({ className, ...props }: PromptInputTabItemProps) => (
  <div
    className={cn('fk:flex fk:items-center fk:gap-2 fk:px-3 fk:py-2 fk:text-xs fk:hover:bg-accent', className)}
    {...props}
  />
);
