...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      className={cn(
        'fk-fixed fk-inset-x-0 fk-right-0 fk-bottom-0 fk-z-50 fk-ml-24 fk-flex fk-h-full fk-flex-col fk-rounded-l-[10px] fk-border fk-border-border fk-bg-background',
        className
      )}
      ref={ref}
      {...props}
