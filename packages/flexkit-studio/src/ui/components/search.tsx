...
export function Search({
  ...
  return (
    <Command
      className="fk:relative fk:overflow-visible fk:h-auto fk:justify-center"
      onBlur={() => {
    ...
    >
      <div
        className={cn(
          'fk:flex fk:items-center fk:border fk:border-border fk:rounded-md fk:px-3 fk:h-9 fk:md:w-[100px] fk:lg:w-[300px] fk:ring-offset-background',
      ...
      >
        ...
        <CommandPrimitive.Input
          className={cn(
            'fk:flex fk:h-9 fk:w-full fk:rounded-md fk:bg-transparent fk:py-1 fk:text-sm fk:outline-hidden fk:placeholder:text-muted-foreground fk:disabled:cursor-not-allowed fk:disabled:opacity-50',
            className
          )}
      ...
      <div className="fk:relative fk:max-w-[600px]">
        <div
          className={cn(
            'fk:mt-1 fk:animate-in fk:fade-in-0 fk:zoom-in-95 fk:absolute fk:top-0 fk:z-10 fk:w-full fk:rounded-md fk:bg-popover fk:outline-hidden fk:drop-shadow-md fk:border fk:border-border',
