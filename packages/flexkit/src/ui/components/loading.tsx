  ...
  return (
    <div className="flex w-full h-full justify-center items-center bg-background">
      <div className="flex flex-col items-center">
        {resolvedTheme === 'dark' ? (
          <svg className="h-8 w-8 animate-bounce" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="text-foreground text-center mt-4 animate-pulse">Loading...</div>
      </div>
    </div>
  );
}
