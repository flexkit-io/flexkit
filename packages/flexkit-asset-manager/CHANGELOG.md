...
- 9bbe14b: Allow Asset Manager uploads to use every supported file type instead of restricting the picker to images.
...
- d1ebaf9: Raise the default listing page size from 25 to 36.
